...
/**
 * The Product class contains the variables and methods that will be used for the inventory.
 */
public class Product{
    ...
    /***
     This method deletes the associated part from the associated parts list.
     @param selectedAssociatedPart the associated part that was selected
     @return false
     */
